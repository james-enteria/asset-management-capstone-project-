		  ...
		  <tbody>
		  	@foreach($transactions as $transaction)
			    ...
			    <tr>
			      ...
			      <td>
			      	<a href="/transaction/{{$transaction->id}}" class="btn btn-warning view-request" {{-- data-toggle="modal" --}} data-id="{{$transaction->user_id}}" data-name="{{$transaction->user->name}}" data-target="#viewRequest">View Request</button>
			      </td>
		  		</form>
		    @endforeach
